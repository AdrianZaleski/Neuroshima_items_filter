...
class Ammo(models.Model):
    ...
    thumbnail = models.ImageField(null=True, blank=True, upload_to="ammo", default="placeholder.png")
...
class Ranged(models.Model):
    ...
    description = models.TextField(blank=True, null=True)
    thumbnail = models.ImageField(null=True, blank=True, upload_to="ranged", default="placeholder.png")
